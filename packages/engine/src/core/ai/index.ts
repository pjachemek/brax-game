/**
 * Brax AI - public surface of the bot.
 *
 ...
 *   evaluation.ts  static scoring and the "should I declare Brax?" heuristic
 ...
 *   player.ts      BraxBot, which is what callers actually use
...
export { countThreatenedPieces, evaluatePosition, shouldDeclareBrax } from './evaluation.ts';
...
export { BraxBot } from './player.ts';
export type { BraxBotOptions, BotMoveDecision } from './player.ts';
